...
class RoIHeads(torch.nn.Module):
    ...
    def assign_targets_to_proposals(self, proposals, gt_boxes, gt_labels):
        ...
        Args:
            proposals: 在rpn中生成的前top_n个anchors，其中去出了边界模糊和无用的anchors，总数小于top_n
            gt_boxes:  batch中每个图像的真实人工标注的proposal
            gt_labels: 每个batch中proposal对应的标签
    ...
    def select_training_samples(self,
        ...
        # 将gt_boxes拼接到proposal后面，避免正负样本的数量差距太大，导致训练精度误差大
